...
public class VendingMachinePRESENTATION{
    /*
    delcare variables to use within program:
        a double for the amount of money the user will have to spend
        a double for the amount of money remaining to spend as the program loops
        a String for the letter the user will enter
        an int for the number the user will enter
        the Scanner that will gather user information
    Loop the program under the condition that the amount of money the user has left is equal to or greater than the price of the cheapest item
    Program Procedure:
        -Print out the introduction to the machine and machine's break command
        -Print out items in the listed order with their prices and item letter/number
        -take input from user for the letter they entered
            -based on letter entered, the program will run the same conditional but call the method cooresponding to that item's letter
            -ex. l is "A"
    */
